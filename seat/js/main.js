...
;(function(window) {
	...
	var support = {transitions : Modernizr.csstransitions},
		...
		actionBuy = plan.querySelector('button.action--buy'),
		// intro element
	...
	function initEvents() {
		...
		actionBuy.addEventListener('click',Buy);
	...
	function Buy() {
		if(index_seat > 0) {
			window.open("../zf.html","_blank")
			localStorage.setItem("index_seat",index_seat)
			var in1 = localStorage.getItem("in")
			// yp
			var str = localStorage.getItem("name6")
			// yy
